      ...
      <Card title={cardTitle}>
        <Modal
          ...
          <Form
            ...
            {isUpdate ? (
              <Item label='新密码' name='newpwd'>
                <Input placeholder='新密码' />
              </Item>
            ) : null}
            {isUpdate ? (
              <Item label='新密码' name='newpwdtwo'>
        ...
        />
        <Button onClick={this.queryUserList}>列表查询</Button>
        <Button onClick={this.showModal}>新增用户</Button>
